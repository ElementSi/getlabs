...
ax40.vlines(time_res_40[num_devide_40], 0, 120, '#8473f6', linestyle = '--', linewidth = 3)
...
ax80.vlines(time_res_80[num_devide_80], 0, 120, '#8473f6', linestyle = '--', linewidth = 3)
plt.title('Уровень воды в кювете после открытия торцевой двери', loc = 'center', fontsize = 24, wrap = True)
plt.xlabel('Время [с]', fontsize = 18)
plt.ylabel('Уровень воды [мм]', fontsize = 18)
plt.legend(fontsize = 20)
...
ax120.vlines(time_res_120[num_devide_120], 0, 120, '#8473f6', linestyle = '--', linewidth = 3)
plt.title('Уровень воды в кювете после открытия торцевой двери', loc = 'center', fontsize = 24, wrap = True)
plt.xlabel('Время [с]', fontsize = 18)
plt.ylabel('Уровень воды [мм]', fontsize = 18)
plt.legend(fontsize = 20)
