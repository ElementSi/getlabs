...
#import waveFunctions as b              ИСПРАВИТЬ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
samples_120, duration_120, length_120 = read("wave/data/120 mm.txt")

# хз что это

samples_wave, duration_wave, length_wave = read("wave/data/wave.txt")
...
samples_wave_40, duration_wave_80, length_wave_80 = read("wave/data/wave 80 mm.txt")
...
ax0 = plt.axes()
plt.plot(poly_y, poly_x, '#3568e7', linewidth = 3, label = 'Калибровочная функция в диапозоне  [0:3000] отсчетов АЦП')
...
plt.xticks(np.arange(0, 120, 25), fontsize = 16)
...
ax40 = plt.axes()
plt.plot(time_res[:num_devide_40], res[:num_devide_40], '#0000ff', label='Ожидание волны', linewidth = 3)
plt.plot(time_res[num_devide_40:], res[num_devide_40:], '#ff0000', label='Уровень воды в кювете', linewidth = 3)
plt.xlim(0, 15)
plt.ylim(0, 120)
plt.xticks(np.arange(0, 15, 2.5), fontsize = 16)
plt.yticks(np.arange(0, 120, 25), fontsize = 16)
...
ax40.vlines(time_res[num_devide_40], 0, 120, '#8473f6', linestyle = '--', linewidth = 3)
...
ax80 = plt.axes()
plt.plot(time_res[:num_devide_80], res[:num_devide_80], '#0000ff', label='Ожидание волны', linewidth = 3)
plt.plot(time_res[num_devide_80:], res[num_devide_80:], '#ff0000', label='Уровень воды в кювете', linewidth = 3)
plt.xlim(0, 15)
plt.ylim(0, 120)
plt.xticks(np.arange(0, 15, 2.5), fontsize = 16)
plt.yticks(np.arange(0, 120, 25), fontsize = 16)
...
ax80.vlines(time_res[num_devide_80], 0, 120, '#8473f6', linestyle = '--', linewidth = 3)
plt.title('Уровень воды в кювете после открытия торцевой двери', loc = 'center', fontsize = 24, wrap = True)
plt.xlabel('Время [с]', fontsize = 18)
plt.ylabel('Уровень воды [мм]', fontsize = 18)
plt.legend(fontsize = 20)
...
ax120 = plt.axes()
plt.plot(time_res[:num_devide_120], res[:num_devide_120], '#0000ff', label='Ожидание волны', linewidth = 3)
plt.plot(time_res[num_devide_120:], res[num_devide_120:], '#ff0000', label='Уровень воды в кювете', linewidth = 3)
plt.xlim(0, 15)
plt.ylim(0, 120)
plt.xticks(np.arange(0, 15, 2.5), fontsize = 16)
plt.yticks(np.arange(0, 120, 25), fontsize = 16)
...
ax120.vlines(time_res[num_devide_120], 0, 120, '#8473f6', linestyle = '--', linewidth = 3)
plt.title('Уровень воды в кювете после открытия торцевой двери', loc = 'center', fontsize = 24, wrap = True)
plt.xlabel('Время [с]', fontsize = 18)
plt.ylabel('Уровень воды [мм]', fontsize = 18)
plt.legend(fontsize = 20)
